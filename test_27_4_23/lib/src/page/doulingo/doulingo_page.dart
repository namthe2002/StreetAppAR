                  ...
                  itemBuilder: (context, inx) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color: _cubit.index == inx ? R.color.backgroundColor : R.color.green,
                              borderRadius: BorderRadius.circular(16.r)),
                          child: Center(
                            child: Text(
                              _cubit.questions[inx].toString(),
                              style:  _cubit.index == inx ? Theme.of(context).textTheme.bold23Style :
